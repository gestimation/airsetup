---
title: "SAP QC technical reference"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{SAP QC technical reference}
...
[Japanese version](qc-sap-jp.html)
...
Use [PLAN QC](qc-plan.html) for a general analysis plan. Use [M11 SEMANTIC QC](qc-m11semantic.html) first when trial semantics must be organized across documents.
